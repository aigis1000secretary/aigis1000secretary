...
const Lyrics = require('../helpers/lirik.js');
const Ig = require('../helpers/instagram.js');

const LineService = require('../curve-thrift/LineService.js');
const {
  LoginResultType,
  IdentityProvider,
  ContentType,
...
const PinVerifier = require('./pinVerifier.js');
  ...
  _qrCodeLogin() {
    ...
    return new Promise((resolve, reject) => {
      this._client.getAuthQrcode(true, 'Alfathdirk-PC', (err, result) => {
        ...
        qrcode.generate(qrcodeUrl, { small: !false });
